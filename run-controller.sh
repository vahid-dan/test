...
sudo $SNAP/bin/ovs-vsctl add-br snapipop0 2>&1 | tee -a $SNAP_USER_DATA/ovs.log
$SNAP/bin/ovs-vsctl add-br snapipop1 2>&1 | tee -a $SNAP_USER_DATA/ovs.log
...
ovs-vsctl add-br snapipop2 2>&1 | tee -a $SNAP_USER_DATA/ovs.log
which ovs-vsctl
